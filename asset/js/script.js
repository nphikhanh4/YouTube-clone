...
var moreshort = document.querySelector('.short-more')
var moreshortlist = document.querySelector('.more-short')
...
moreshort.addEventListener('click', function(event) {
  moreshortlist.style.display = (moreshortlist.style.display === 'flex') ? 'none' : 'flex';
  event.stopPropagation();
});
function changeText1() {
  var element = document.getElementById("textToChange1");
  if (element.innerHTML === "Hiện thêm") {
      element.innerHTML = "Ẩn bớt";
  }   else {
      element.innerHTML = "Hiện thêm";
      }
  }
...
// video1
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var video1s = document.querySelectorAll(".video1");
  
    video1s.forEach(function(video) {
      video.currentTime =10;
      video.addEventListener("mouseenter", function () {
  
        video1s.forEach(function(otherVideo) {
          if (otherVideo !== video) {
            otherVideo.pause();
  ...
  function changeText3() {
    ...
    if (element.innerHTML === "Đăng Ký") {
        element.innerHTML = "Đã Đăng Ký";
        
    }   else {
        element.innerHTML = "Đăng Ký";
        }
    }