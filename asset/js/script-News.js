...
var morelist = document.querySelector('.list-more')
var morelist2 = document.querySelector('.more-list')

morelist.addEventListener('click', function(event) {
  morelist2.style.display = (morelist2.style.display === 'flex') ? 'none' : 'flex';
  event.stopPropagation();
});
